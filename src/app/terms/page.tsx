    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600">For questions about these terms, please contact us at <a href="mailto:mohammed.anees@halyse.com" className="text-blue-700">mohammed.anees@halyse.com</a>.</p>
        </div>
      </section>
    </>
  );
